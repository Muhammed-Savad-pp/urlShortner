...
import type { IUserLogin } from "../interface/user"
                    ...
                    <div className="bg-gray-900/40 backdrop-blur-2xl border border-gray-700/50 rounded-3xl p-6 shadow-2xl">
                        ...
                        <div className="mt-3 text-center">
                            <p className="text-gray-400 text-lg">
                                ...
                                <button onClick={() => navigate('/signup')} className="text-green-400 hover:text-green-300 font-semibold transition-colors duration-300 hover:underline">
                                    Sign Up
                                </button>
                            </p>
                        </div>
